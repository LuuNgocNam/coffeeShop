...
router.get(
  "/admin/nhanvien/edit/:id",
  AuthMiddleware.checkAdmin,
  NhanvienController.edit
);
router.post(
  "/admin/nhanvien/update/:id",
  AuthMiddleware.checkAdmin,
  UploadMiddleware.upload.single("thumbnail"),
  NhanvienController.update
);
router.get(
  "/admin/nhanvien/delete/:id",
  AuthMiddleware.checkAdmin,
  NhanvienController.del
);
...
router.post(
  "/admin/hoadon/store",
  AuthMiddleware.checkAdmin,
  HoadonController.store
);
router.get(
  "/admin/hoadon/edit/:id",
  AuthMiddleware.checkAdmin,
  HoadonController.edit
);
router.post(
  "/admin/hoadon/update/:id",
  AuthMiddleware.checkAdmin,
  HoadonController.update
);
router.get(
  "/admin/hoadon/delete/:id",
  AuthMiddleware.checkAdmin,
  HoadonController.del
);
...
router.get(
  "/admin/cthoadon",
  AuthMiddleware.checkAdmin,
  CthoadonController.index
);
router.get(
  "/admin/cthoadon/create",
  AuthMiddleware.checkAdmin,
  CthoadonController.create
);
router.post(
  "/admin/cthoadon/store",
  AuthMiddleware.checkAdmin,
  CthoadonController.store
);
router.get(
  "/admin/cthoadon/edit/:id",
  AuthMiddleware.checkAdmin,
  CthoadonController.edit
);
router.post(
  "/admin/cthoadon/update/:id",
  AuthMiddleware.checkAdmin,
  CthoadonController.update
);
router.get(
  "/admin/cthoadon/delete/:id",
  AuthMiddleware.checkAdmin,
  CthoadonController.del
);
...
router.get(
  "/admin/datban/create",
  AuthMiddleware.checkAdmin,
  DatbanController.create
);
router.post(
  "/admin/datban/store",
  AuthMiddleware.checkAdmin,
  DatbanController.store
);
router.get(
  "/admin/datban/edit/:id",
  AuthMiddleware.checkAdmin,
  DatbanController.edit
);
router.post(
  "/admin/datban/update/:id",
  AuthMiddleware.checkAdmin,
  DatbanController.update
);
router.get(
  "/admin/datban/delete/:id",
  AuthMiddleware.checkAdmin,
  DatbanController.del
);
...
router.get(
  "/admin/baiviet/edit/:id",
  AuthMiddleware.checkAdmin,
  BaiVietController.edit
);
router.post(
  "/admin/baiviet/update/:id",
  AuthMiddleware.checkAdmin,
  UploadMiddleware.upload.single("thumbnail"),
  BaiVietController.update
);
router.get(
  "/admin/baiviet/delete/:id",
  AuthMiddleware.checkAdmin,
  BaiVietController.del
);
...
router.get(
  "/admin/dichvu/create",
  AuthMiddleware.checkAdmin,
  DichVuController.create
);
router.post(
  "/admin/dichvu/store",
  AuthMiddleware.checkAdmin,
  UploadMiddleware.upload.single("thumbnail"),
  DichVuController.store
); // post cr prd
router.get(
  "/admin/dichvu/edit/:id",
  AuthMiddleware.checkAdmin,
  DichVuController.edit
);
router.post(
  "/admin/dichvu/update/:id",
  AuthMiddleware.checkAdmin,
  UploadMiddleware.upload.single("thumbnail"),
  DichVuController.update
);
router.get(
  "/admin/dichvu/delete/:id",
  AuthMiddleware.checkAdmin,
  DichVuController.del
);
...
router.get("/PaySuccess", SiteController.paySuccess);
